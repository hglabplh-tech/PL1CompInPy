...
def runtime_function_table() -> FunctionTable:
    ...
    table.add_runtime("COMMAND", "runtime.command_line.command", [], returns="CHARACTER")
    table.add_runtime("ARGC", "runtime.command_line.argc", [], returns="FIXED BIN")
    table.add_runtime("ARGV", "runtime.command_line.argv", [ParameterDescriptor("INDEX", "FIXED BIN", "value")], returns="CHARACTER")
    table.add_runtime("DYNLOAD", "runtime.dynload.open", [ParameterDescriptor("PATH", "CHARACTER", "value")], returns="POINTER")
    table.add_runtime("DYNSYM", "runtime.dynload.symbol", [ParameterDescriptor("LIBRARY", "POINTER"), ParameterDescriptor("NAME", "CHARACTER", "value")], returns="POINTER")
    table.add_runtime("JAVA_LOAD_CLASS", "runtime.jvm.class_loader.load", [ParameterDescriptor("CLASS", "CHARACTER", "value")], returns="POINTER")
    table.add_runtime("DOTNET_LOAD_ASSEMBLY", "runtime.dotnet.assembly_load", [ParameterDescriptor("ASSEMBLY", "CHARACTER", "value")], returns="POINTER")
